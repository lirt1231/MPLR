...
class Configure(object):
    def __init__(self) -> None:
        ...
        self.train_file = os.path.join(self.dataset_dir, "train.json")
        ...
        self.all_file = os.path.join(self.dataset_dir, "all.txt")
        """Saved paths"""
        ...
        self.HP_query_embed_dim = 128
        self.HP_num_rnn_layers = 1
        self.HP_rnn_hidden_size = 128
